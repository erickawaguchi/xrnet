...
[![Build Status](https://travis-ci.org/USCbiostats/xrnet.svg?branch=master)](https://travis-ci.org/USCbiostats/xrnet)
...
2. Install xrnet package with the install_github function (optionally you can install the most recent / potentially unstable development branch)
3. Load the package 
