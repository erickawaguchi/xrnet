                  ...
                  control          = list())
{
    ...
    fit <- fitModelRcpp(
        ...
        cmult            = penalty$cmult,
        quantiles        = c(penalty$quantile,
                             penalty$quantile_ext),
        gamma            = c(penalty$gamma,
                             penalty$gamma_ext),
        num_penalty      = c(penalty$num_penalty,
                             penalty$num_penalty_ext),
        penalty_ratio    = c(penalty$penalty_ratio,
